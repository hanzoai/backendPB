                ...
                <Field class="form-field form-field-toggle m-b-sm" let:uniqueId>
                    ...
                    <label for={uniqueId}>
                        ...
                        <i
                            ...
                            use:tooltip={{
                                text: 'By default HanzoBase uses the unix "sendmail" command for sending emails. For better emails deliverability it is recommended to use a SMTP mail server.',
                                position: "top",
                            }}
                        />
                    </label>
